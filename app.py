...
def Ja_Pred():
    data = request.get_json()  # Assuming you are sending JSON data from the frontend
    Ja_Description = ["tightly healed|hard|non softening|impermeable rock mineral filing less than 1mm of joint seperation",
...
def Jw_Pred():
    data = request.get_json()  # Assuming you are sending JSON data from the frontend
    Jw_Description = ["Dry excavation or minor inflow 5 decays per minute locally with head water less than 10m",
